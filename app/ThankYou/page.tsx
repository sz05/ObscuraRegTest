    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-12 relative z-10">
        <div className="w-full max-w-md mx-auto text-center space-y-8">
          <h1
            className="text-3xl md:text-5xl font-bold tracking-wider font-zen-dots"
          >
          ...
          <div className="pt-6 md:pt-10">
            <Link href="/Dashboard">
              <Button
                className="py-5 px-8 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-bold text-lg shadow-[0_0_15px_4px_rgba(239,68,68,0.4)] transition-all duration-300 rounded-lg tracking-wider"
              >
                GO TO DASHBOARD
              </Button>
            </Link>
